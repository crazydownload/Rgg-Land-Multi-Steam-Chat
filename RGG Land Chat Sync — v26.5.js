// ==UserScript==
// @name         RGG Land — чат + листочек + стена кнопкой (v26.5)
// @namespace    rgg.land.chat.sync
// @version      26.5
// @description  v26.5: гибрид игры rgg.land + Twitch + плашка «сообщество/активность» скрыта навсегда (статичный сдвиг чата вверх, оба режима). Dock уважает открытую стену: прячет родной чат сайта чисто через visibility/pointer-events (без мерцания, клики по стримерам с 1-го клика).
